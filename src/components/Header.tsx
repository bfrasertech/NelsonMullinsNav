    ...
    public render(): React.ReactElement<IHeaderProps> {
        ...
        <div>
            ...
            <div className='nmrs-nav-alert-container'>
                <div className='nmrs-nav-alert-message'><span>Alert: System will be down for maintenance Saturday 3/14/19 from 7 PM to 9 PM EST</span>
                </div>
                <button type='button' className='nmrs-nav-alert-close-button' onClick={() => this.setState({showAlert: false})}><FontAwesomeIcon icon={faTimesCircle} /></button>
            </div>}
